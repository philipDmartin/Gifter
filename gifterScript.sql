...
VALUES 
  (1, '3AlJ7rJXDbg8k0SgHcFnsc3y9nA3', 'Oliver Hardy', 'olie@email.com', null, null, '06-21-2020');
INSERT INTO [UserProfile]
  ([Id], [FirebaseUserId], [Name], [Email], [ImageUrl], [Bio], [DateCreated])
VALUES 
  (2, 'JsNe9lJ2TLccvSjZwZUJiTGFiZS2', 'Stan Laurel', 'stan@email.com', null, null, '04-20-2020');
